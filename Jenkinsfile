pipeline{
   ...
   stage('Terraform Plan') {
    steps {
      ...
      wrap([$class: 'VaultBuildWrapper', configuration:  [$class: 'VaultConfiguration',vaultUrl: 'http://127.0.0.1:8200',vaultCredentialId:"cd71e714-d5e3-761d-393a-4ae127513b7e"], vaultSecrets :  [
