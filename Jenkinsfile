pipeline{
   ...
   stage('Terraform Plan') {
    steps {
      ...
      wrap([$class: 'VaultBuildWrapper', configuration:  [$class: 'VaultConfiguration',vaultUrl: 'http://127.0.0.1:8200', vaultCredentialId:'21db8baf-b74b-4634-7420-ba5fd71dfe4e'], vaultSecrets :  [
